...
document.addEventListener('DOMContentLoaded', () => {
    (() => {
        window.renderMapCard = function (obj, index, map) { // создание метки на карте
            ...
            function onCardEscPress(evt) {
                if (window.utils.getEscEvent(evt)) {
                    closeCard();
                }
            }
            ...
            mapCard.querySelector('small').textContent = obj.offer.address;
